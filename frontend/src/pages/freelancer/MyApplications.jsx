  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      <div className="panel rounded-[32px] p-6 md:p-8">
        ...
        <h2 className="mt-4 text-xl font-semibold text-[#0d1e36] md:text-2xl">Keep track of every proposal you send.</h2>
      ...
      <div className="mt-6 space-y-5">
        ...
        {applications.length === 0 && (
          <div className="panel rounded-[28px] p-10 text-center">
            <p className="text-xl font-semibold text-[#0d1e36]">No applications yet</p>
