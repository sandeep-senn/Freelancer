  ...
  return (
    <div className="mx-auto flex max-w-7xl gap-6 px-4 py-6">
      <aside className="panel hidden w-72 rounded-[30px] p-5 lg:block">
        ...
        <h3 className="mt-4 text-xl font-semibold text-[#0d1e36]">Review by skill stack</h3>
      ...
      <main className="flex-1">
        <div className="panel rounded-[32px] p-6 md:p-8">
          ...
          <h2 className="mt-4 text-xl font-semibold text-[#0d1e36] md:text-2xl">Review all platform projects in one place.</h2>
        </div>
