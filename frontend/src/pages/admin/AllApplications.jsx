  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      <div className="panel rounded-[32px] p-6 md:p-8">
        ...
        <h2 className="mt-4 text-xl font-semibold text-[#0d1e36] md:text-2xl">Monitor all submitted proposals.</h2>
      </div>
      ...
      <div className="mt-6 space-y-5">
        {applications.map((app) => (
          <div key={app._id} className="panel rounded-[28px] p-6">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-4 text-sm font-sans text-[#0d1e36]">
